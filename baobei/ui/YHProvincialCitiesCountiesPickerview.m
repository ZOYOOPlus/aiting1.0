//
//  YHProvincialCitiesCountiesPickerview.m
//  baobei
//
...
#define YHAddressPickerViewHeight 216

@interface YHProvincialCitiesCountiesPickerview () <UIPickerViewDataSource,UIPickerViewDelegate>
...
@implementation YHProvincialCitiesCountiesPickerview
...
- (void)show {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        self.pickView.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height - YHAddressPickerViewHeight, self.frame.size.width, YHAddressPickerViewHeight);
...
- (void)hide {
    _backView.alpha = 0;
    [UIView animateWithDuration:0.5 animations:^{
        self.pickView.frame = CGRectMake(0, [UIScreen mainScreen].bounds.size.height+44, self.frame.size.width, YHAddressPickerViewHeight);
...
- (UIPickerView*)pickView {
    if (!_pickView) {
        _pickView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height + 44, self.frame.size.width, YHAddressPickerViewHeight)];
