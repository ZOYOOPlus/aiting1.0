...
static NSString *cellD = @"HImageListCell";
...
- (UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[ShowCell class] forCellWithReuseIdentifier:cellD];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
       ShowCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellD forIndexPath:indexPath];
    ...
    // 请求没有数据的原因 是 showPhotoMode 需要放到最后加载 。。。。
